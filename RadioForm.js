...
export class RadioButtonInput extends React.Component {
	...
	render () {
		...
		var radioStyle = [
			Style.radio,
			{ borderColor:outerColor, borderWidth:borderWidth },
		...
		return (
			<TouchableWithoutFeedback
				...
				<View style={[ this.props.labelWrapStyle, Style.labelWrapStyle, ]} >
					<Text style={[ Style.radioLabel, !this.props.labelHorizontal && Style.labelVertical, {color: this.props.labelColor}, this.props.labelStyle ]}>
